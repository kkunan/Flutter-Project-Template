...
// in oic_next_to_you/test/features/auth/data/datasources/network_otp_datasource_test.dart.
...
/// A class which mocks [PhoneAuthProviderWrapper].
///
/// See the documentation for Mockito's code generation for more information.
class MockPhoneAuthProviderWrapper extends _i1.Mock
    implements _i6.PhoneAuthProviderWrapper {
  MockPhoneAuthProviderWrapper() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.PhoneAuthCredential? getCredential(
          {String? verificationId, String? smsCode}) =>
      (super.noSuchMethod(Invocation.method(#getCredential, [], {
        #verificationId: verificationId,
        #smsCode: smsCode
      })) as _i3.PhoneAuthCredential?);
}
